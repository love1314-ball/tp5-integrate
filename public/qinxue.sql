...
Source Database       : qinxue

Target Server Type    : MYSQL
Target Server Version : 50726
File Encoding         : 65001

Date: 2020-04-16 16:55:03
*/
...
-- Records of ob_admin
-- ----------------------------
INSERT INTO `ob_admin` VALUES ('1', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1', '1586597953', '127.0.0.1', '26', '0', '1586597953');
...
CREATE TABLE `ob_admin_log` (
  ...
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='管理员日志';
...
CREATE TABLE `ob_auth_rule` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='权限规则';

-- ----------------------------
-- Records of ob_auth_rule
-- ----------------------------
INSERT INTO `ob_auth_rule` VALUES ('1', '0', '文章', '', 'fa fa-book', '2', 'nav', '0', '1');
INSERT INTO `ob_auth_rule` VALUES ('2', '0', '用户', '', 'fa fa-users', '3', 'nav', '0', '1');
...
INSERT INTO `ob_auth_rule` VALUES ('56', '0', '曲种管理', 'admin/Song/index', 'fa fa-bell-o cc_pointer', '0', 'nav', '0', '1');
INSERT INTO `ob_auth_rule` VALUES ('57', '56', '增加分类', 'admin/Song/add', '', '0', 'auth', '0', '1');
INSERT INTO `ob_auth_rule` VALUES ('58', '0', '戏曲', 'admin/Play/index', 'fa fa-female cc_pointer', '0', 'nav', '0', '1');
INSERT INTO `ob_auth_rule` VALUES ('59', '58', '增加戏曲', 'admin/Play/add', '', '0', 'auth', '0', '1');
INSERT INTO `ob_auth_rule` VALUES ('60', '56', '曲种管理', 'admin/Song/index', '', '0', 'nav', '0', '1');
INSERT INTO `ob_auth_rule` VALUES ('61', '58', '戏曲列表', 'admin/Play/index', '', '0', 'nav', '0', '1');
...
CREATE TABLE `ob_user` (
  ...
  `mailbox` varchar(255) DEFAULT '' COMMENT '手机',
